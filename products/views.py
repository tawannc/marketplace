...
def product_create(request):
    ...
    if request.method == 'POST':
        ...
        form.fields['category'].queryset = Category.objects.filter(seller=seller)  # ← AQUI
        ...
        form = ProductForm()
        form.fields['category'].queryset = Category.objects.filter(seller=seller)  # ← AQUI TAMBÉM
